...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TopBarFloatingPopUp.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/alb.garciam@gmail.com/TopBarFloatingPopUp'
  ...
  # s.resource_bundles = {
  #   'TopBarFloatingPopUp' => ['TopBarFloatingPopUp/Assets/*.png']
  # }
